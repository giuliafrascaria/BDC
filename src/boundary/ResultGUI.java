...
public class ResultGUI {
	...
	public ResultGUI(int accountType, JPanel mainPanel, int queryType, String[] inputs, String[][] outputs) {
		...
		lblTitle.setBounds(326, 85, 190, 30);
		...
		lblSubTitle.setBounds(138, 120, 510, 20);
		...
		case 1: lblSubTitle.setText("Ricerca per nome: " + inputs[0]);
				...
				for (int i=1; i<result.length; i++) {
					txtResult.setText(txtResult.getText() + "__" +result[i]);
				}
				break;
		case 2: lblSubTitle.setText("Ricerca entro un raggio: " + inputs[0] + " " + inputs[1] + " " + inputs[2] + " " + inputs[3]);
				break;
